/*
This example shows how to use LilyGO T-HiGrow- Lora SHIELD to connect to TTN/ChirpStack and display the data in Cayenne.
2019/12/31 lewis he
*/
...
// LSB mode
static const u1_t PROGMEM DEVEUI[8] = { 0x01, 0x11, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
// MSB mode
